...
ActiveRecord::Schema[7.1].define(version: 2024_06_03_212627) do
  ...
  create_table "buffet_photos", force: :cascade do |t|
    t.integer "buffet_id", null: false
    t.integer "photo_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["buffet_id"], name: "index_buffet_photos_on_buffet_id"
    t.index ["photo_id"], name: "index_buffet_photos_on_photo_id"
  end
  ...
  add_foreign_key "buffet_photos", "buffets"
  add_foreign_key "buffet_photos", "photos"
